public class TextOutput {
    ...
    public static void askForTeacherSelectAction() {
        System.out.println("\tВведите \"1\" если хотите добавить вопрос " +
                ...
                "\n\tВведите \"3\" если хотите изменить вопрос" +
                "\n\tВведите \"4\" если хотите удалить вопрос" +
                "\n\tВведите \"5\" если хотите вернуться к выбору роли" +
                "\n\tВведите \"6\" если хотите выйти из приложения");
    }
    ...
    public static void askForDesireToPassAnotherQuiz() {
        System.out.println("Желаете продолжить?" +
                "\n\tВведите \"1\" если хотите пройти еще один квиз" +
                "\n\tВведите \"2\" если хотите вернуться к выбору роли" +
                "\n\tВведите \"3\" если хотите выйти из приложения");
    }
